...
function Profile(props) {
    ...
    const onChangeName = ()=>{
        ...
        const resp = axios.patch(url2,{"fist_name":name})
        profiledata.first_name = name
        setNameField(false)
    }

    const onChangeName2 = ()=>{
        
        const resp = axios.patch(url2,{"last_name":name2})
        profiledata.last_name = name2
        setNameField2(false)
    }
    ...
    return (
        <div className="profile">
            ...
            <img src= {`${process.env.REACT_APP_API_URL}${profiledata.image}`} /> 
          ...
          onChange={(e) => setSelectedFile(e.target.files[0])}/>
            ...
            <div className="personal-section">
                ...
                <div className="name">
                {!namefield?
                <h1>First Name: {profiledata.first_name}</h1>
                :
                ...
                <div className="name">
                {!namefield2?
                <h1>Last Name: {profiledata.last_name}</h1>
                :
                <div className="conditioned-input">
                <input 
                type="text"
                ...
                />
                <button onClick={onChangeName2}>Save</button>
                </div>
                }
