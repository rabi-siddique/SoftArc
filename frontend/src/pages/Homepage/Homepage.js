    ...
    return (
        <div className="home-container">
            ...
            <div className="px-2 flex flex-col items-center justify-center">
                ...
                <Link to="/login">
                <button class="focus:outline-none w-full sm:w-auto bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-3 text-sm mt-6">
                                    Login
                </button>
                </Link>
            </div>
