...
<div class="w-3/4 md:w-1/2 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative dark:bg-red-700 dark:text-red-100" role="alert">
<strong class="font-bold">Extension Error!</strong>
<span class="block sm:inline"> Select Files with the right extension.</span>
