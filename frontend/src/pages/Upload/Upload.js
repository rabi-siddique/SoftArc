...
<div class="flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
  ...
  <p>{fileNo} files have been select. Press the Upload button to continue.</p>
    ...
    <label class="block w-full">
                <span class="text-gray-700">Select File Extension</span>
                <select class="form-select mt-1 block w-full bg-gray-200 text-gray-700" required value={filetype} onChange={e => setFileTye(e.target.value)}>
    ...
    <label
  className="w-full flex flex-col items-center px-4 py-6 bg-white rounded-md shadow-md tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-600 hover:text-white text-white-600 ease-linear transition-all duration-150">
  ...
  <strong class="font-bold">Wrong File Extension Selected!</strong>
  <span class="block">Please Upload Files with the selected File Extension</span>
  <span class="absolute top-0 bottom-0 right-0 px-4 py-3 w-full">
    <svg onClick={()=>{
                    setErrorMessage(false)
                    seterrorfiles([])
                    setSelected(null)
                    }}
    class="fill-current ml-48 h-6 w-full text-red-500" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><title>Close</title><path d="M14.348 14.849a1.2 1.2 0 0 1-1.697 0L10 11.819l-2.651 3.029a1.2 1.2 0 1 1-1.697-1.697l2.758-3.15-2.759-3.152a1.2 1.2 0 1 1 1.697-1.697L10 8.183l2.651-3.031a1.2 1.2 0 1 1 1.697 1.697l-2.758 3.152 2.758 3.15a1.2 1.2 0 0 1 0 1.698z"/></svg>
  </span>
</div>}
